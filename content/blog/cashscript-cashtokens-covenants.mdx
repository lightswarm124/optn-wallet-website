...
For the broader model, read the [Bitcoin Cash covenants guide](/covenants-on-bitcoin-cash), revisit the [CashTokens guide](/cashtokens), or open the [developer resources](/developers) for the surrounding wallet and application layers.
