...
const initialState = {
  ...
  company: "",
  email: "",
  need: "Hosted infrastructure access",
  timeline: "",
  details: "",
};
    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <label className="text-left">
          ...
          <select
            ...
            className="w-full rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-white outline-none transition-colors focus:border-accent-primary/60"
          >
            <option>Hosted infrastructure access</option>
            <option>Wallet / covenant implementation help</option>
            <option>Architecture review / advisory</option>
      ...
      <label className="mt-4 block text-left">
        ...
        <input
          ...
          value={form.timeline}
          onChange={updateField}
          placeholder="e.g. shipping in April 2026"
