    ...
    <div className="page-shell">
      <section className="page-hero">
        <div className="site-container page-hero-grid">
          <div><SectionLabel>Developers</SectionLabel><h1>Build your BCH product on a stronger foundation.</h1><p className="page-hero-copy">OPTN Wallet exposed the hard parts of building a useful BCH product. These public resources help you work through the same primitives—CashTokens, covenants, metadata, wallet connections, and infrastructure—on your own.</p><div className="hero-actions"><ButtonLink href="/engineering">Talk to engineering</ButtonLink><ButtonLink href="https://github.com/OPTNLabs/OPTNWallet" variant="secondary">View GitHub</ButtonLink></div></div>
